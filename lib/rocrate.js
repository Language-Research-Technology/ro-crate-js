...
class ROCrate {
     ...
     */
    addProfile(uri) {
        this.addValues(this.rootId, "conformsTo", { "@id": uri });
    }
     ...
     */
    toJSON() {
        return { '@context': this.#context, '@graph': this.serializeGraph() };
    }
    ...
    serializeGraph() {
        ...
        for (let item of this.getGraph(true)){
